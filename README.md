...
Lectura: carga un Excel con una columna de fecha, una columna de la
estación a completar y una o varias columnas de estaciones
auxiliares.
Validación: detecta y avisa de fechas no interpretables, columnas
vacías y valores negativos de precipitación (físicamente
imposibles), sin modificar nada automáticamente.
Preparación por pares: para cada estación auxiliar, construye un
...
Ajuste de regresiones: calcula la recta de regresión para cada par,
...
el motivo.
Selección del mejor modelo: entre las estaciones auxiliares que
superan un número mínimo de datos y un R² mínimo (configurables),
se elige la de mayor R².
Completado: aplica la ecuación seleccionada sobre la serie completa
...
Trazabilidad: cada valor completado queda registrado con la fecha,
...
SIN COMPLETAR.
Exportación: genera un único Excel con los datos originales, los
